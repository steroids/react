...
const defaultFetchHandler = list => (dispatch, getState, {http}) => {
    ...
    return dispatch(
        http.send(list.actionMethod, url || location.pathname, {
            ...list.query,
            page: list.page,
...
const createList = (listId, props) => (dispatch, getState, {clientStorage}) => dispatch({
...
export const setLayoutName = (listId, layoutName) => (dispatch, getState, {clientStorage}) => {
