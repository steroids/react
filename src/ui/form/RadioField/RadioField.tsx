 ...
 */
export interface IRadioFieldProps extends IFieldWrapperInputProps, IDataProviderConfig,
...
export interface IRadioFieldViewProps extends IFieldWrapperOutputProps {
    inputProps: {
        name: string,
        type: string,
        disabled?: boolean,
