...
function DateTimeField(props: IDateTimeFieldProps) {
    ...
    }, [props.input.value, parseDate, props.valueDateFormat, props.timeFormat]);
    ...
    }, [props.valueDateFormat, props.timeFormat, props.input.onChange, parseDate]);

    useEffect(() => {
        setState(parseToState(props));
    }, [parseToState, props.input.value, props.valueDateFormat, props.timeFormat]);
