...
export default class Accordion extends React.PureComponent {
    ...
    render() {
        const AccordionView = this.props.view || this.props.ui.getView('list.AccordionView');
        return (
            <AccordionView
                {...this.props}
    ...
    _renderHeader(item, index) {
        const AccordionItemHeaderView = this.props.headerView || this.props.ui.getView('list.AccordionItemHeaderView');
